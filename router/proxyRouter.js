...
router.get('/catalog/parse/data/:link/:selected/:ishot?', proxyController.parse_data);
...
router.get('/catalog/parse/params/:link/:selected/:ishot?', proxyController.parse_params);
